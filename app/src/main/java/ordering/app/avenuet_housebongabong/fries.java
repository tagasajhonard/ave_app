...
public class fries extends Fragment {
...
//            throw new RuntimeException(context.toString() + " must implement OnProductClickListener");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fries, container, false);
        ...
        FirebaseRecyclerOptions<Product> options =
                new FirebaseRecyclerOptions.Builder<Product>()
                        .setQuery(productsRef.orderByChild("Category").equalTo("Fries"), Product.class)
                        .build();
