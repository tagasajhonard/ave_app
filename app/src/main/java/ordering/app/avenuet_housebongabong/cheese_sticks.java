...
public class cheese_sticks extends Fragment {
...
//            throw new RuntimeException(context.toString() + " must implement OnProductClickListener");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cheese_sticks, container, false);
        ...
        FirebaseRecyclerOptions<Product> options =
                new FirebaseRecyclerOptions.Builder<Product>()
                        .setQuery(productsRef.orderByChild("Category").equalTo("Cheese Sticks"), Product.class)
                        .build();
