...
public class fruit_tea extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fruit_tea, container, false);
        ...
        FirebaseRecyclerOptions<Product> options =
                new FirebaseRecyclerOptions.Builder<Product>()
                        .setQuery(productsRef.orderByChild("Category").equalTo("Fruit Tea"), Product.class)
                        .build();
...
//                holder.itemView.setOnClickListener(v -> onProductClickListener.onProductClick(model));
