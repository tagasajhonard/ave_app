...
public class mozzarella extends Fragment {
...
//            throw new RuntimeException(context.toString() + " must implement OnProductClickListener");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_mozzarella, container, false);
        ...
        FirebaseRecyclerOptions<Product> options =
                new FirebaseRecyclerOptions.Builder<Product>()
                        .setQuery(productsRef.orderByChild("Category").equalTo("Mozzarella"), Product.class)
                        .build();
