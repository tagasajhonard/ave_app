...
public class to_ship extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new OrdersAdapter(getContext(), orderList, "to ship", null);
...
//        ordersRef = FirebaseDatabase.getInstance().getReference("Orders");
//
//        // Query to filter orders by customer name
//        ordersRef.child(custname).addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot snapshot) {
//                orderList.clear(); // Clear previous data
...
//                    Orders order = orderSnapshot.getValue(Orders.class);
//                    if (order != null && "accepted".equals(order.getStatus())) {
//                        // Loop through the list of items and add them to the orderList
//                        List<Orders.Item> items = order.getItems();
//                        if (items != null) {
//                            orderList.addAll(items); // Add all items from the order
//                        }
//                    }
//                }
//
